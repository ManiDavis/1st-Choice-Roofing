...
export const STATIC_SERVICES: StaticService[] = [
  ...
  },
  {
    ...
    title: 'Solar Roofing',
    slug: 'solar-roofing',
    shortDescription: 'Professional solar panel installations and removals across Massachusetts & New England. Mounting systems, roof preparation, and clean solar panel removal for re-roofing projects.',
    icon: '☀️',
    serviceType: 'both',
  },
]
...
export const STATIC_SERVICE_DETAILS: Record<string, StaticServiceDetail> = {
  ...
  'rubber-flat-roofing': {
    ...
    benefits: [
      ...
      { title: 'Long-Lasting Results', description: 'Properly installed flat roofing should give you decades of trouble-free service with minimal maintenance.' },
  ...
  'solar-roofing': {
    ...
    serviceType: 'both',
    benefits: [
      { title: 'Solar Installations', description: 'We install solar mounting systems and prepare roofs for panel placement — done right the first time.' },
      { title: 'Panel Removals', description: 'Need panels removed for a roof replacement or repair? We handle safe, clean solar panel removal and reinstallation.' },
      { title: 'Roof-Ready Assessment', description: 'Before any solar work begins, we ensure your roof structure is sound and in top condition.' },
      { title: 'Massachusetts & New England Coverage', description: 'Serving MA and all surrounding New England states for both residential and commercial solar roofing.' },
    ],
    process: [
      { step: 1, title: 'Free Consultation', description: 'Talk through your solar installation or removal needs — we assess what\'s required.' },
      { step: 2, title: 'Roof Assessment', description: 'We inspect the roof to confirm it\'s structurally ready for solar and identify any prep work needed.' },
      { step: 3, title: 'Installation or Removal', description: 'Our team carries out the solar roofing work safely and efficiently, on schedule.' },
      { step: 4, title: 'Final Inspection', description: 'A thorough post-job inspection and sign-off before we leave the site.' },
    ],
  },
}
